...
| `busico_m3` | M3 RTO | Safe real-time optimization under unmeasured disturbances: a finite-sample, distribution-free constraint-satisfaction guarantee | IEEE Trans. Control Systems Technology | 26-0876 (v2) | under review | `paper2/tcst/` |
...
@misc{busico_m3,
  ...
  author={Busico, Bien}, year={2026}, note={Manuscript 26-0876, under review at IEEE Transactions on Control Systems Technology}}
