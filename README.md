...
[![CI](https://github.com/USERNAME/IPIS/actions/workflows/ci.yml/badge.svg)](https://github.com/USERNAME/IPIS/actions/workflows/ci.yml)
...
```bash
# Clone
git clone https://github.com/USERNAME/IPIS.git
cd IPIS
...
@software{busico_ipis_2026,
  ...
  year = {2026},
  url = {https://github.com/USERNAME/IPIS}
}
```
