...
\hypertarget{soft-sensing-under-delayed-infrequent-and-irregular-measurements}{%
\subsection{Soft sensing under delayed, infrequent, and irregular measurements}\label{soft-sensing-under-delayed-infrequent-and-irregular-measurements}}
...
wastewater plant. Our transport-lag \emph{diagnosis} (§3.1) is the static counterpart of
...
\hypertarget{process-model-migration}{%
\subsection{Process model migration}\label{process-model-migration}}
...
\hypertarget{conformal-prediction-for-time-series}{%
\subsection{Conformal prediction for time series}\label{conformal-prediction-for-time-series}}
...
What this thread has not addressed is the \emph{instantiation} that §3.4 and §3.6 require: in
...
threaded through \emph{both} mechanisms --- the bias update of §3.3 consumes the label at its
...
is their \emph{integration under one validation discipline} --- blocked CV with a parsimony
