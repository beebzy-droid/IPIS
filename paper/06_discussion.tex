...
\hypertarget{validity-without-accuracy-is-the-production-stance}{%
\subsection{Validity without accuracy is the production stance}\label{validity-without-accuracy-is-the-production-stance}}
...
static baseline \emph{around a point model with negative R²}. An operator reading those
...
\hypertarget{where-the-performance-comes-from}{%
\subsection{Where the performance comes from}\label{where-the-performance-comes-from}}
...
\hypertarget{the-linear-scope-is-a-design-choice-and-what-it-costs}{%
\subsection{The linear scope is a design choice, and what it costs}\label{the-linear-scope-is-a-design-choice-and-what-it-costs}}
...
subsampling, the presence of the online layer): it measured \textasciitilde3.3× in early runs and
...
\hypertarget{practitioners-recipe-and-future-work}{%
\subsection{Practitioner's recipe and future work}\label{practitioners-recipe-and-future-work}}
