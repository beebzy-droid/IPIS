...
\subsection{Validity without accuracy is the production stance}
...
1.0$\times$/4.0$\times$ under the frozen protocol --- one reason the paper commits to provenance-
...
The online implementation was designed for connection to plant data infrastructure (OPC~UA/MQTT ingestion was prototyped and deliberately gated out of scope); closing that loop turns the reference implementation into a plant pilot. And the evidence-freeze
