...
\item
  \textbf{K4 --- Transfer, honestly scoped}: the methodology transfers across process
...
\item
  \textbf{K5 --- A negative control and a deployment}: on SECOM, where no physics exists to
