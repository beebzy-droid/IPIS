...
$\boldsymbol\psi$. Appendix~\ref{app:bearing} carries the rolling-contact case through to a numerical
instance and identifies $\boldsymbol\psi$ for that law explicitly, which is where the abstraction
