...
The unifying message is that none of the three guarantees implies system safety on its own;
the composition is the certificate. The remainder of the paper reviews the relevant
