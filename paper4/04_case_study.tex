...
$1.0\times10^{-3}$ process noise. Thermophysical properties --- relative
...
over $700$ operating points spanning the box, split $450$ for fitting and $250$ for
the conformal calibration residuals. On held-out twin data its adaptive conformal
...
\emph{responds} to its setpoint moves --- the endogeneity identified in the
